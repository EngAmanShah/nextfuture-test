...
const translations = {
  ...
  ar: {
    ...
    successDesc: "تم إرسال ملف  النسخة التجريبية مع دليل الاستخدام. استمتع بتجربتك مع نيكست  فيوتشر!",
    ...
    agreeFull: "بالتسجيل، فإنك توافق على شروط نيكست  فيوتشر وسياسة الخصوصية",
    placeholders: {
