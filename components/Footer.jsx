...
export default function Footer({ lang }) {
  ...
  const arabicText = {
    ...
    companyNameFull: "شركة نيكست  فيوتشر لتقنية المعلومات",
    description:
      "في نيكست  فيوتشر، نرسم لك خارطة طريق نحو الابتكار، مقدمين حلول تقنية غير تقليدية تعزز رؤيتك. دعنا نكون شريكك في رحلة التحول الرقمي، حيث نحقق طموحاتك بأفكار جريئة وتقنيات رائدة. انضم إلينا لصنع مستقبل مشرق سويًا!",
    links: {
      home: "الرئيسية",
      services: "خدماتنا",
      contact: "تواصل معنا",
