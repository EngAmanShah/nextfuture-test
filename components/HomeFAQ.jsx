...
const faqs = {
  ar: [
    {
      question: "ما هي نكست فيوتشر ؟",
      answer:
        "نكست فيوتشر هي منصة ERP متكاملة مصممة للأعمال الحديثة، تجمع بين الإدارة المالية، والمبيعات، والمخزون، وإدارة علاقات العملاء، ورؤى مدعومة بالذكاء الاصطناعي في نظام واحد متكامل.",
    },
    {
      question: "لمن تم تصميم نكست فيوتشر ؟",
      answer:
        "تم تصميم نكست فيوتشر للشركات الناشئة والمؤسسات الصغيرة والمتوسطة والشركات الكبيرة التي ترغب في تحسين كفاءة العمليات وإدارة أعمالها من منصة واحدة.",
    },
    {
      question: "ما هي المميزات التي تقدمها نكست فيوتشر؟",
      answer:
        "تقدم نكست فيوتشر إدارة مالية متكاملة، وتتبع المبيعات، وإدارة المخزون، ونظام CRM، ولوحات تقارير تحليلية، ورؤى ذكية مدعومة بالذكاء الاصطناعي.",
    },
    {
      question: "هل يمكن تخصيص نكست فيوتشر حسب احتياجات الشركة؟",
      answer:
        "نعم، يمكن تخصيص نكست فيوتشر ليتناسب مع طبيعة عمل شركتك ومتطلباتك التشغيلية.",
    },
    {
    ...
    {
      question: "هل نكست فيوتشر نظام سحابي؟",
      answer:
        "نعم، نكست فيوتشر متاح كنظام سحابي آمن يتيح لك الوصول إلى بيانات عملك في أي وقت ومن أي مكان.",
    },
    {
      question: "كيف يمكنني البدء باستخدام نكست فيوتشر؟",
      answer:
        "يمكنك التواصل معنا عبر الموقع الإلكتروني لحجز عرض توضيحي ومناقشة كيفية استفادة عملك من نكست فيوتشر.",
    },
  ],
  en: [
    {
